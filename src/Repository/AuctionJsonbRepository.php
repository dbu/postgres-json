...
/**
 * @extends ServiceEntityRepository<AuctionJsonb>
 */
class AuctionJsonbRepository extends ServiceEntityRepository implements AuctionInterface
{
    public function __construct(
        ...
        parent::__construct($registry, AuctionJsonb::class);
    }
    ...
    public function createAuction(Item $item): AuctionJsonb
    {
        $data = $this->serializer->normalize($item);
        $auction = new AuctionJsonb($item->title, $item->startDate, $item->endDate, $data);
    ...
    public function updateAuction(AuctionJsonb $auction, Item $item): void
    {
        $data = $this->serializer->normalize($item);
    ...
    public function extractItem(AuctionJsonb $auction): Item
    {

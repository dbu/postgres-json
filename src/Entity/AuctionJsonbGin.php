...
/**
 * Variant with jsonb data and a Generalized Inverted Index (GIN).
 *
 * The GIN can not be defined in Doctrine. It is hand coded in the migrations.
 */
#[ORM\Entity(repositoryClass: AuctionJsonbGinRepository::class)]
#[ORM\Index(fields: ['startDate'])]
class AuctionJsonbGin
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
